...
export function createFooter() {
    ...
    list.innerHTML = '<li class="element-list-footer"><a href="#">О клинике</a></li>' +
                    '<li class="element-list-footer"><a href="#">Услуги</a></li>' +
                    '<li class="element-list-footer"><a href="#">Специалисты</a></li>' + 
                    '<li class="element-list-footer"><a href="#">Цены</a></li>' +
                    '<li class="element-list-footer"><a href="#">Контакты</a></li>'
